...
Ported from DDT_Lab: source/ddt_lab/ddt_lab/tasks/manager_based/locomotion/robots/d1h/flat_env_cfg.py
"""

from isaaclab.utils import configclass

from .d1h_env_cfg import D1hEnvCfg


@configclass
class D1hFlatEnvCfg(D1hEnvCfg):
