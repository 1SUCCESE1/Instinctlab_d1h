"""D1H-specific curriculum terms.

Ported from DDT_Lab: source/ddt_lab/ddt_lab/tasks/manager_based/locomotion/mdp/curriculums.py
"""
...
def command_levels_lin_vel(
    ...
    """Grow the lin_vel command range as the tracking reward improves."""
...
def command_levels_ang_vel(
    ...
    """Grow the ang_vel command range as the tracking reward improves."""
    base_velocity_ranges = env.command_manager.get_term("base_velocity").cfg.ranges
